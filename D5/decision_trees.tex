...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{DTree.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{influentialVariablesDTree.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{heatmapDTree.png}
