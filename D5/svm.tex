...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Images/plot_mds-1.png} % Ensure this image exists
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Images/plot_roc-1.png} % Ensure this image exists
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Images/plot_residuals-1.png} % Ensure this image exists
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Images/plot_boxplots-1.png} % Ensure this image exists
