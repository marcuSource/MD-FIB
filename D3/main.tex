...
The project timeline spans from September 10, 2025, to October 21, 2025, with a total duration of 42 days. The following table presents the detailed task schedule:

\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|p{0.8cm}|p{4.5cm}|p{2.5cm}|p{1.8cm}|p{1.8cm}|p{1.2cm}|}
\hline
\rowcolor{lightgray}
\textbf{\textcolor{primaryblue}{Task}} & \textbf{\textcolor{primaryblue}{Description}} & \textbf{\textcolor{primaryblue}{Assigned}} & \textbf{\textcolor{primaryblue}{Start}} & \textbf{\textcolor{primaryblue}{End}} & \textbf{\textcolor{primaryblue}{Days}} \\
\hline
T1-T4 & Cover, Index, Motivation, Data Source & All members & 10/09/25 & 10/09/25 & 1 \\
\hline
T5-T7 & Data structure, metadata, DM process, Preprocessing & \textbf{Jesus} & 10/09/25 & 24/09/25 & 14 \\
\hline
T8 & Statistical descriptive analysis & \textbf{Arnau} & 17/09/25 & 01/10/25 & 14 \\
\hline
T9 & PCA analysis for numerical variables & \textbf{Marc} & 01/10/25 & 08/10/25 & 7 \\
\hline
T10 & Hierarchical Clustering analysis & \textbf{Aglaya} & 08/10/25 & 15/10/25 & 7 \\
\hline
T11 & Cluster Profiling and interpretation & \textbf{Michel} & 15/10/25 & 21/10/25 & 6 \\
\hline
T12-T14 & Conclusions, Working plan, R Scripts & All members & 24/09/25 & 21/10/25 & 27 \\
\hline
\end{tabular}
\caption{\textcolor{primaryblue}{Project Task Schedule and Assignments}}
\label{tab:gantt}
\end{table}
