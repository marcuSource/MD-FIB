...
\subsection{Step 2: Visualizing data}
 ...
 explicar cómo visualizamos los datos 

\subsection{Step 3: Filtering variables selection}

 qué objetos hemos seleccionado? \\
 hay variables redundantes? \\
 qué filas hemos cogido?: definir target population \\
 qué columnas hemos cogido?: determine objects description \\
